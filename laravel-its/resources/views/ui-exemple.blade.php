...
<body>
    ...
    <div class="container mx-auto px-4">
        <h1 class="text-2xl font-bold mb-4 mt-4">UI example</h1>
        <h2 class="text-xl font-bold mb-4">Some buttons</h2>
        ...
        <h2 class="text-xl font-bold mb-4 mt-8">Some forms and cards</h2>
